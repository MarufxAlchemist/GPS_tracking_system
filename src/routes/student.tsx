    ...
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <div className="relative max-w-md mx-auto px-5 py-6 space-y-5">
        ...
        <header className="flex items-center justify-between">
          ...
          <button className="relative size-10 rounded-xl glass flex items-center justify-center">
        ...
        {/* Join zone */}
        <button className="w-full flex items-center justify-between glass rounded-2xl p-4 hover:bg-white/10 transition">
        ...
        {/* SOS */}
        <button className="relative w-full overflow-hidden rounded-3xl p-6 group glow-danger" style={{ background: "linear-gradient(135deg, oklch(0.5 0.25 25), oklch(0.45 0.24 15))" }}>
          ...
          <div className="relative flex flex-col items-center gap-2">
            ...
            <div className="font-display text-xl font-bold text-white">SOS Emergency</div>
            <div className="text-xs text-white/80">Tap and hold to send distress signal</div>
          </div>
        </button>
      </div>
    </div>
